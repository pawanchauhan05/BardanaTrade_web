                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1 class="null">Congratulations!</h1>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h2 class="null">Hi <?php echo $name ?>,</h2>

<p>Welcome to BardanaTrade!<br>
Thanks for joining. We're excited to have you on board.</p>

<p><strong>Account details</strong><br>
<strong>Login URL: </strong><?php echo $login ?><br>
<strong>Username:</strong><?php echo $email ?></p>

<p>What's next?<br>
Here are details of some basic steps that you should have to complete for Sell or Buy products.<br>
<br>
<strong>Step 1 :</strong> Complete your basic profile.<br>
<strong>Step 2&nbsp;:</strong> For sell or buy post your product details.<br>
<br>
We are always here to help.<br>
Have a question? just Contact Us.<br>
<br>
