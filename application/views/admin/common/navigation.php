        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-edit"></i> Products <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              ...
              <li><a href="form_advanced.html">Buy Products</a></li>
            </ul>
          </li>
          ...
          <li><a><i class="fa fa-table"></i> Latest Products <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="tables.html">Bags</a></li>
              <li><a href="tables_dynamic.html">Twine & Yarn</a></li>
              <li><a href="tables_dynamic.html">Machines</a></li>
            </ul>
          </li>
